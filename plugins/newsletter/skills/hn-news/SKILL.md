---
name: hn-news
description: "Hacker News AI 뉴스 수집. HN에서 AI 관련 새 뉴스를 확인하고 싶을 때 사용."
---

# Hacker News 뉴스 수집 스킬
...
```bash
python3 {SKILL_DIR}/scripts/hn_collector.py 2>/dev/null
```
