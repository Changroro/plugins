...
AskUserQuestion:
- question: "Telegram에서 @userinfobot 에게 아무 메시지를 보내면 본인의 chat_id(숫자)를 알려줍니다. 그 숫자를 입력하세요."
...
- OK → "테스트 메시지를 보냈습니다. Telegram에서 확인하세요." 다음 단계로 진행.
- FAILED → "chat_id가 올바르지 않습니다. @userinfobot에서 다시 확인해주세요." 재입력 요청.
